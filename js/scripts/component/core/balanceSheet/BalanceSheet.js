...
define(["jquery", "configurator/Configurator", "modelController/ModelsController",
    ...
    data = [
        [ 1, 2 ,11, 21, 22, 1, 20130210, true],
        [ 1, 3 , 11, 21, 123123, 2, 20130210, false],
        [2, 2 , 12, 23, 2222, 3, 20130211, true],
        [2, 3 , 12,23, 888, 1, 20130212, false],
        [1, 3 , 11, 22, 345435345, 2, 20130211, true],
        [1, 3, 11, 23, 1111313, 3, 20130212, false]
    ]
    data2 = [
    ...
    data3 = [
        ["note","20140102",1,'KG',1,11],
        ["note","20140103",2,'KG',2,13],
        ["note","20140105",3,'KG',2,16],
        ["note","20140107",4,'KG',1,14],
        ["note","20140108",5,'KG',1,16]
    ]
    // -----------------------------------------------------------------------------------------
